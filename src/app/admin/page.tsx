...
const Admin: React.FC = () => {
  ...
  const updateItem = async () => {
    ...
    if (
      ...
      const requiredDocsArray = Array.isArray(item.requiredDocs)
        ? item.requiredDocs
  ...
  return (
    <div className="p-5">
      {notice ? (
        <div
          role="alert"
          className="bg-green-500 rounded-lg font-bold flex items-center justify-center p-3 fixed gap-2 bottom-4 left-4"
        >
          <svg
      ...
      <div className="flex justify-between">
        <div className="flex gap-5 mb-3">
          <Link
            href="/packages"
            className="bg-blue-600 py-1.5 px-3 rounded-lg flex items-center gap-2"
          >
            <svg
        ...
        <button
          className="bg-red-600 py-1.5 px-3 rounded-lg"
      ...
      <div className="flex flex-col overflow-x-auto">
            ...
            {items.map((item) => (
              <tr key={item.id} className="border-b border-neutral-500">
                ...
                <td className="text-center items-center h-12 relative">
                  ...
                  >
                    <svg
                      className="w-6 h-6 text-white hover:text-gray-500 transition"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 16 3"
                  ...
                  <div
                    id={"menu-" + item.id}
                    className={`absolute right-16 top-0 z-10 flex flex-col mt-8 mr-2 p-2 border border-gray-800 rounded bg-primary ${
                      visibleMenuId === item.id ? "" : "hidden"
                    }`}
                  >
                    <button
                      className="hover:bg-slate-600 p-2 rounded flex gap-2"
        ...
        <div
          className={`${
            deleteModal ? "" : "hidden"
          } flex items-center justify-center fixed z-50 top-0 right-0 w-full h-screen bg-black`}
        >
          <div className="bg-neutral-800 p-4 m-4 mx-6 rounded-lg h-fit">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                className="bg-red-500 px-3 py-1.5 rounded text-xl"
              >
                {deleting ? (
                  <div>
                    <div className="flex justify-center">
              ...
              <button
                ...
                className="bg-neutral-500 px-3 py-1.5 rounded text-xl"
              >
                No, Cancel
              </button>
            </div>
        ...
        <div
          className={`${
            updateOpen ? "" : "hidden"
          } flex overflow-hidden justify-center fixed z-50 top-0 right-0 w-full h-screen bg-black`}
        >
          <form className="flex flex-col gap-2 text-black py-8 pb-24 mx-auto overflow-y-auto w-full px-4 max-w-2xl no-scrollbar">
            ...
            <input
              ...
              value={item.processTime}
              onChange={(e) =>
                setItem({ ...item, processTime: e.target.value })
              }
              onKeyDown={(e) => {
                if (e.key === "Enter") {
                  e.preventDefault();
            ...
            <div className="flex justify-center gap-4">
              ...
              <button
                className="bg-red-600 font-bold text-white py-2 px-3 rounded-lg hover:bg-red-700 transition"
                onClick={(e) => {
                  e.preventDefault();
                  setUpdateOpen(false);
                  setItem({
