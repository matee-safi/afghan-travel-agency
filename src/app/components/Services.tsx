      ...
      <div className="container">
        ...
        <div className="p-5">
          <div className="text-center flex flex-col items-center my-10">
            ...
            <Link className="btn-primary" href="packages">See Visa Packages</Link>
          </div>
          ...
          <div className="text-center flex flex-col items-center my-10">
            ...
            <Link className="btn-primary" href="packages">See Scholarship Packages</Link>
          </div>
          ...
          <div className="text-center flex flex-col items-center my-10">
            ...
            <Link className="btn-primary" href="packages">See Ticket Prices</Link>
          </div>
