        ...
        <div className="p-5 md:grid md:grid-cols-2">
          <div className="text-center flex flex-col items-center my-10">
            ...
            <p className="mb-3 mx-4 max-w-sm lg:text-xl">
              We offer visa assistance for many countries, including Pakistan,
              Iran, Qatar and, etc. You can see all of our Visa packages and
              their prices by pressing the button bellow.
            </p>
          ...
          <div className="text-center flex flex-col items-center my-10">
            ...
            <p className="mb-3 mx-4 max-w-sm lg:text-xl">
              We offer Scholarships for many countries, including England,
              Scotland, Belarus and, etc. Our team of professional consultants
              will help you on every step of your journey.
            </p>
          ...
          <div className="text-center flex flex-col items-center my-10">
            ...
            <p className="mb-3 mx-4 max-w-sm lg:text-xl">
              ...
              national and international flights, ensuring affordable travel
              options for all your journeys and destinations.
            </p>
          ...
          <div className="text-center flex flex-col items-center my-10">
            ...
            <p className="mb-3 mx-4 max-w-sm lg:text-xl">
              We offer Asylum Offers to a variety of countries with great
              conditions, you'll block your money at an agiotage and pay us when
