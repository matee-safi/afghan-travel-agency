    ...
    <section id="about">
      <div className="container mx-auto md:flex">
        <div className="w-full md:mt-4 lg:mt-6">
          ...
          <p className="m-5 lg:text-xl">At Afghan Travel Agency, with over a decade of experience, we&apos;re dedicated to simplifying your travel dreams. We offer reliable visa assistance, the lowest ticket prices, and exclusive scholarships to Europe. Plus, our full refund policy ensures your journey is stress-free.</p>
          <p className="m-5 lg:text-xl font-semibold text-red-300">You can find our location in this interactive map.</p>
        </div>
